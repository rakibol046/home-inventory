...
export default function Login() {
  ...
  const [username, setUsername] = useState("rakib@homebox.com");
  ...
  return (
    ...
    //   <div className="flex-1 login flex  h-screen justify-center items-center ">
    //     <div className="flex flex-col gap-12 max-w-lg">
    //       <img src={img} alt="dm image" className="" />
    //       <div className="flex flex-col gap-3 text-center ">
    //         <h1 className="text-[#1E293B] text-2xl font-semibold">
    //           Organize Everything
    //         </h1>
    ...
    //     </div>
    //   </div>
    //   <div className="flex-1 h-screen flex flex-col gap-12 justify-center items-center">
    //     <div className="flex flex-col text-center ">
    //       <h1 className="text-[#1E293B] text-2xl font-bold">Home Inventory</h1>
    //       <p className="text-[#475569]">Track and organize your things</p>
    //     </div>
